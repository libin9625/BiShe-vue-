<template>
  <div class="manageClass">
    <router-link to="/teacher/noticeAdd"><el-button type="text">添加公告</el-button></router-link>
    <el-table
      ...
      width="100">
        <template slot-scope="scope">
          <router-link to="/teacher/noticeUpdate"><el-button type="text" @click="handleUpdate(scope.row)">修改</el-button></router-link>
